...
public extension Networking {
    ...
    func fakeGET(_ path: String, response: Any?, statusCode: Int = 200) {
        registerFake(requestType: .get, path: path, headerFields: nil, response: response, responseType: .json, statusCode: statusCode)
    }
...
public extension Networking {
    ...
    func fakePATCH(_ path: String, response: Any?, statusCode: Int = 200) {
        registerFake(requestType: .patch, path: path, headerFields: nil, response: response, responseType: .json, statusCode: statusCode)
    }
...
public extension Networking {
    ...
    func fakePUT(_ path: String, response: Any?, statusCode: Int = 200) {
        registerFake(requestType: .put, path: path, headerFields: nil, response: response, responseType: .json, statusCode: statusCode)
    }
...
public extension Networking {
    ...
    func fakeDELETE(_ path: String, response: Any?, statusCode: Int = 200) {
        registerFake(requestType: .delete, path: path, headerFields: nil, response: response, responseType: .json, statusCode: statusCode)
    }
...
public extension Networking {
    ...
    func fakeImageDownload(_ path: String, image: Image?, statusCode: Int = 200) {
        registerFake(requestType: .get, path: path, headerFields: nil, response: image, responseType: .image, statusCode: statusCode)
    }
